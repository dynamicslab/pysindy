...
class PDEFindSteady:
    ...
    def setup(self):
        ...
        self.feature_library = ps.PDELibrary(spatial_grid=spatial_grid, derivative_order=3)
    ...
    def track_pdefind_steady(self):
        ...
        true_coeff, model_coeff = sindy_exp._utils.unionize_coeff_dicts(model, self.true_coeff)
