...
\end{equation}
where $\boldsymbol{\Xi} = [\boldsymbol{\xi}_1,\boldsymbol{\xi}_2,\dots,\boldsymbol{\xi}_p]$ contain the sparse coefficients.  
...
# Acknowledgments
\texttt{PySINDy} is a fork of [`sparsereg`](https://github.com/Ohjeah/sparsereg) [@markus_quade_sparsereg].
...
![Caption for example figure.\label{fig:package-structure}](Fig1.png)
![Caption for example figure.\label{fig:pde_id}](Fig2.png)
