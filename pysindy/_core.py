...
class SINDy(_BaseSINDy):
    ...
    def predict(self, x, u=None):
        ...
        """
        if not _check_multiple_trajectories(x, 1, None, u):
            x, _, _, u = _adapt_to_multiple_trajectories(x, 1, None, u)
    ...
    def _process_trajectories(
        ...
        if x_dot is None:
            if self.discrete_time:
                ...
                )  # type: ignore  (It's cause zip loses types)
        return x, x_dot
...
def _validate_inputs(x, t, x_dot, u) -> None:
